...
export function RightProtocolPanel() {
  ...
  return (
    <aside className="right-protocol-panel">
      ...
      <section className="protocol-card freeze-detail card"><h4>Freeze Detection (Read Only)</h4><dl><div><dt>Freeze Threshold:</dt><dd>{camera.freezeStrategy.threshold.toFixed(2)}</dd></div><div><dt>Minimum Freeze Duration:</dt><dd>{camera.freezeStrategy.minDurationSec.toFixed(2)} s</dd></div></dl></section>
